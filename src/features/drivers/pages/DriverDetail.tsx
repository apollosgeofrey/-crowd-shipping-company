            ...
            <div className="card shadow-sm rounded p-4">
                ...
                <div className="d-flex align-items-center mb-4">
                    <div className="d-flex align-itCreateems-center gap-3">
                        <img src={userMale} alt="Driver" className="rounded" style={{ width: "80px", height: "80px", objectFit: "cover" }}/>
                        <div>
                            ...
                            <p className="mb-0 fw-semibold">
                                <span className="fa fa-wallet me-2"></span><span className="text-info">Driver</span>
                            </p>
                        </div>
                    </div>
