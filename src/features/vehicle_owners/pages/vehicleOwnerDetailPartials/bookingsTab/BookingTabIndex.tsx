...
export default function BookingTabIndex({ vehicleOwner }: any) {
    // logic
    ...
    const bookingTabs = [
        ...
        { id: "in-progress", label: "In Progress", icon: <FaSpinner /> },
    ...
    return (
        <div className="">
            <div className="col-sm-12">{vehicleOwner?.fullName}</div>
            {/* Booking Tabs */}
            ...
            {activeBookingTab === "in-progress" && (<InProgressTab />)}
