// pages/users/tabs/OfflineTab.tsx
...
export default function OfflineTab({
    ...
    // Mock demo data
    const drivers: OfflineDrivers[] = [
        { id: 1, totalDeliveries: "2", name: "23456 - Prince Emmae", dateJoind: "Mar 05, 2025", status: "Offline" },
        { id: 2, totalDeliveries: "4", name: "23466 - Mercy", dateJoind: "April 20, 2025", status: "Offline" },
        { id: 3, totalDeliveries: "5", name: "34567 - Daniel",  dateJoind: "October 05, 2025", status: "Offline" },
        { id: 4, totalDeliveries: "7", name: "23566 - Luke Ball", dateJoind: "August 12, 2025", status: "Offline" },
    ];
                            ...
                            {drivers.map((driver) => (
                                <tr key={driver.id}>
                                    ...
                                    <td className="py-2 px-2">
                                        <span className={`col-sm-12 badge bg-warning-subtle rounded text-warning fw-semibold px-3 py-2`}>{driver.status}</span>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
