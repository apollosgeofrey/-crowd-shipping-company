...
export default function AdminEdit() {
    ...
    // form submit handler for updating admin
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();

        if (!id) {
            setMessage({ type: "error", text: "Invalid admin ID." });
        ...
        try {
            ...
            const res = await adminApi.updateAdmin(id, updateData);
            if (res.code === 200) {
                setMessage({ type: "success", text: res.message || "Admin updated successfully." });
                        ...
                        <div className="col-sm-12">
                            <div className="card shadow-sm border-0 p-5 d-flex align-items-center justify-content-center text-center" style={{ minHeight: "250px" }}>
                                <div>
                                    ...
                                    <p className="mt-2 mb-0 text-muted fw-semibold">Loading admin data...</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <div className="d-flex">
                                        <button type="button" className="btn btn-link text-decoration-none text-primary fw-semibold border-bottom" style={{ borderBottom: "3px solid #E35D3F" }}>
                                            <h5 className="mb-0"><i className="fa fa-edit me-1"></i> Edit Admin</h5>
                                        </button>
                                    </div>
                                        ...
                                        <div className="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                                            ...
                                            <button type="submit" disabled={loading} className="btn btn-sm btn-primary" style={{ backgroundColor: "#E35D3F", borderColor: "#E35D3F" }}>
                                                {loading ? (
                                                    ...
                                                    <><span className="fa fa-save"></span> Update Admin</>
                                                )}
                                            </button>
                                        </div>
                                    </form>
