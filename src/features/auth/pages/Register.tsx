		...
		<CompanyAuthLayout>
			<div>
		        ...
		        <div className="text-center mb-3">
		          	<small className="text-muted fw-bold">Have an Account?</small>
		          	<Link to="/login" className="text-primary fw-bold ms-2">Sign In</Link>
		        </div>
		        ...
		        <form onSubmit={submit} noValidate>
			        ...
			        <div className="mb-4">
			            ...
			            <input type="password" className="form-control" placeholder="Enter Password Confirmation" value={form.confirm_password}
			              required onChange={(e) => setForm({ ...form, confirm_password: e.target.value })}/>
			        </div>
			        ...
			        <div className="text-center small text-muted mb-4 fw-bold">
			        	By creating account, you agree to our<br />
			            <Link to="/terms-of-service" className="text-primary fw-bold">Terms of Service.</Link>
			        </div>

			        <hr />

			        <div className="text-center small text-muted mb-4 fw-bold">Or create an account using:</div>
