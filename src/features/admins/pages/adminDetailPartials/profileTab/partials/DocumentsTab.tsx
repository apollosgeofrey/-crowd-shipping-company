...
export default function DocumentsTab({ user }: { user: any }) {
    ...
    const handleViewDocument = (imageUrl: string, title: string) => imageUrl ? window.open(imageUrl, '_blank') : alert(`No ${title} available`);
                                ...
                                <div key={index} className="col-md-6 col-lg-4">
                                    <div className="card border shadow-sm">
                                        <div className="card-body text-center py-3">
                                            ...
                                            <small className="text-muted d-block text-truncate" title={docId}>ID: {docId}</small>
