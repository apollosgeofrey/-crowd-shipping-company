// pages/trips/tabs/AcceptedTab.tsx
...
export default function AcceptedTab({
    ...
    // Demo/mock data
    const trips: AcceptedTrip[] = [
        { id: 1, trip: "23456 - Lagos Island to Canada", dateSent: "Feb 01, 2025", deliveryDate: "Mar 05, 2025", status: "Accepted" },
        { id: 2, trip: "23466 - Murtala Muhammed International Airport to England", dateSent: "April 20, 2025", deliveryDate: "June 20, 2025", status: "Accepted" },
        { id: 3, trip: "34567 - Abuja to Rwanda", dateSent: "April 05, 2025", deliveryDate: "October 05, 2025", status: "Accepted" },
        { id: 4, trip: "23566 - Delta to Zambia", dateSent: "May 12, 2025", deliveryDate: "August 12, 2025", status: "Accepted" },
    ];
                    ...
                    <table className="table align-middle border table-hover">
                        ...
                        {trips.map((trip) => (
                            ...
                            <td className="py-2 px-2">
                                <span className={`col-sm-12 badge bg-primary-subtle rounded text-primary fw-semibold px-3 py-2`}>{trip.status}</span>
                            </td>
                            </tr>
                        ))}
                        </tbody>
