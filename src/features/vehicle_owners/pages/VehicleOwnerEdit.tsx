...
export default function VehicleOwnerEdit() {
    ...
    // Fetch vehicle owner data on component mount
    useEffect(() => {
            ...
            try {
                ...
                if (res.code === 200 && res.data) {
                    ...
                    setFormData({
                        ...
                        confirmPassword: "",
                        status: vehicleOwner.status || "active"
                    });
                } else {
                    setMessage({ type: "error", text: "Failed to load vehicle owner data." });
                }
            } catch (err: any) {
    ...
    // Handle cancel and go back to previous page
                        ...
                        <div className="col-12 col-md-8">
                            <div className="card shadow-sm border-0 p-5 d-flex align-items-center justify-content-center text-center" style={{ minHeight: "250px" }}>
                                <div>
                                    ...
                                    <p className="mt-2 mb-0 text-muted fw-semibold">Loading vehicle owner data...</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                                        ...
                                        <button 
                                            ...
                                            style={{ backgroundColor: "#E35D3F", borderColor: "#E35D3F" }}
                                        >
                                            {loading ? (
                                                <><span className="spinner-border spinner-border-sm text-white" role="status"></span> Updating...</>
                                            ) : (
                                                <><span className="fa fa-save"></span> Update Vehicle Owner</>
                                            )}
                                        </button>
                                    </div>
                                </form>
